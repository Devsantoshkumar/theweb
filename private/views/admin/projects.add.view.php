                ...
                <?php $this->view('admin-includes/topbar'); ?>
                   ...
                   <div class="row p-4">
                    <div class="col d-flex justify-content-between align-items-center">
                      <span class="pageHeading fs-5">Publish new project</span>
                        ...
                        <div class="card-header border-0 bg-white text-muted h3 fw-bold text-center">Publish Project</div>
                          <div class="card-body px-5">
                              ...
                              <div class="input-group mb-5">
                                  <input type="text" name="title" class="form-control shadow-none" value="<?=get_val('title')?>" placeholder="Project title">
                              </div>

                                <div class="input-group mb-5">
                                  <textarea name="description" class="form-control shadow-none" rows="5" placeholder="Description"><?=get_val('description')?></textarea>
                                </div>
                                ...
                                <div class="input-group mb-5">
                                    <input type="text" name="price" class="form-control shadow-none" value="<?=get_val('price')?>" placeholder="Enter price for project">
                                </div>

                                <div class="input-group mb-5">
                                  <input type="text" name="meta_title" class="form-control shadow-none" value="<?=get_val('meta_title')?>" placeholder="Meta title">
                                </div>

                                <div class="input-group mb-5">
                                  <textarea name="meta_description" class="form-control shadow-none" rows="5" placeholder="Meta Description"><?=get_val('meta_description')?></textarea>
                                </div>
                                <?php 
